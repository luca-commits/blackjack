...
public:
    static bool get_player(const std::string& player_id, player*& player_ptr);
    static bool add_player(std::string name, const std::string& player_id, player*& player_ptr);
