...
This is a simplified C++ implementation of Black Jack. 

For Information about the full game and its rules check wikipedia:
...
This project only works on UNIX systems (Linux / MacOS). 
...
We encourage you to watch this well-explained tutorial video on wxWidgets. The video focuses on layouting, but also shows you how to setup a basic wxWidget application: https://www.youtube.com/watch?v=kPB5Y6ef9d
